    ...
    return (
        <div className="flex flex-col justify-between p-3 w-full overflow-hidden">
            ...
            <div className="w-full flex flex-col lg:flex-row justify-between">
                <div className="flex gap-2 lg:gap-4 uppercase font-[font-2] text-4xl lg:text-[3.5vw] leading-[3vw]">
                    <h1 className="border  px-4 lg:px-10 pt-5 pb-3 lg:pt-4 lg:pb-2 rounded-full ">fb</h1>
                    <h1 className="border px-4 lg:px-10 pt-5 pb-3 lg:pt-4 lg:pb-2 rounded-full">ig</h1>
                    <h1 className="border px-4 lg:px-10 pt-5 pb-3 lg:pt-4 lg:pb-2 rounded-full">in</h1>
                    <h1 className="border px-4 lg:px-10 pt-5 pb-3 lg:pt-4 lg:pb-2 rounded-full">be</h1>
                </div>


                <div className='mt-15 lg:mt-0'>
                    <h1 className="border w-fit uppercase lg:leading-[3vw] leading-[12vw] pt-3 px-4 lg:px-10 lg:pt-2 lg:pb-2 rounded-full text-6xl lg:text-[3.5vw]">Contact</h1>
                </div>
